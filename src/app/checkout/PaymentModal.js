  ...
  return (
    <div className="fixed inset-0 z-[1102] bg-black bg-opacity-50 flex justify-center items-center p-4">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-lg">
        <h2 className="text-4xl font-bold text-center text-gray-900 mb-8 border-b-2 border-gray-300 pb-4">পেমেন্ট বিস্তারিত</h2>

        {/* Display total cost and partial payment details if applicable */}
        <p className="text-lg text-gray-800 mb-3">মোট খরচ: <strong>৳{totalCost}</strong></p>
        {paymentOption === 'partial' && (
          <>
            <p className="text-lg text-gray-800 mb-3">অ্যাডভান্স পরিমাণ: <strong>৳{totalPartialPrice}</strong></p>
            <p className="text-lg text-gray-800 mb-3">বাকি পরিমাণ: <strong>৳{dueAmount}</strong></p>
          </>
        )}
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-3">পেমেন্ট অপশন নির্বাচন করুন:</label>
          <div className="flex items-center space-x-6">
            <label htmlFor="bkash" className="flex items-center space-x-3 cursor-pointer hover:scale-105 transition-transform duration-300">
              ...
              />
              <Image src={bkash} alt="bKash" width={80} height={80} className="transform transition duration-200 hover:scale-110" />
            </label>
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-2">যে নম্বর থেকে টাকা পাঠানো হয়েছে তা প্রবেশ করুন:</label>
          <input
            type="tel"
